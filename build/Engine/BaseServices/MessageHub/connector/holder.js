...
class ConnectorHolder {
	constructor() {
		let default_options = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];
	...
	add(connector, options) {
		try {
			let Model = get_model(connector.model);
...
exports.default = ConnectorHolder;
